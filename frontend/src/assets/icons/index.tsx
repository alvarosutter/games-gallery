export { default as rockPaperScissors } from './rockPaperScissors.png';
export { default as higherLower } from './higherLower.png';
export { default as pigGame } from './pigGame.png';
